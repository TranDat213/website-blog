...
export default function SignUpPage() {
  ...
  const handleSocialSignUp = (provider: string) => {
    window.location.href = `/memorizz-api/auth/${provider.toLowerCase()}`;
  };
      ...
      <div className={styles.container}>
            ...
            <Card className={styles.authCard}>
              <CardContent className={styles.cardContent}>
                <div className={styles.header}>
                  ...
                  <p>Join our community of digital memorizers and start organizing the world's knowledge.</p>
                </div>
        ...
        <div className={styles.featuredSide}>
          <div className={styles.featuredCard}>
            <div className={styles.featuredHeader}>Featured Memorizz</div>
